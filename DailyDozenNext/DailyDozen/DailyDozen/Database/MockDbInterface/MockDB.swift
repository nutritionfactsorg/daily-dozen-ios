...
//    switch scenario {
//    case .simple:
//        return await createSqlTracker(date: dateBeforeDays(daysBeforeToday))
//    case .complex:
//        return await createSqlTracker(date: dateBeforeDays(daysBeforeToday))
//    }
//}
//
//func fetchMockDataId(daysBeforeToday: Int, scenario: MockDataScenario = .simple) async -> SqlDailyTrackerId {
//    switch scenario {
//    case .simple:
//        let tracker = await createSqlTracker(date: dateBeforeDays(daysBeforeToday))
...
////
////}
//func createSqlTracker(date: Date) async -> SqlDailyTracker {
//    var tracker = await SqlDailyTracker(date: date)
//    
//    // Add count 3 for beans
//    let countBeans = await SqlDataCountRecord(
//        date: date,
...
//    let countGreens = await SqlDataCountRecord(
//        date: date,
...
//    
//    await data.append(createSqlTracker(date: Date()))
//    await data.append(createSqlTracker(date: dateBeforeDays(-2)))
//    await data.append(createSqlTracker(date: dateBeforeDays(-5)))
...
//   // print("mockDB updated")
//}
//
//@MainActor func updateMockDB(with tracker: SqlDailyTracker) {
...
//}
//
//@MainActor func returnSQLDataArray(date: Date = Date()) async -> [SqlDailyTracker] { // ::EDIT::
//    var data: [SqlDailyTracker] = []
//    
//    await data.append(createSqlTracker(date: date))
//    await data.append(createSqlTracker(date: dateBeforeDays(-2, today: date)))
//    await data.append(createSqlTracker(date: dateBeforeDays(-5, today: date)))
//    await data.append(createSqlTracker(date: dateBeforeDays(-30, today: date)))
//    await data.append(createSqlTracker(date: dateBeforeDays(-364, today: date)))
//    // data.append(createSqlTracker(date: Date()))
//    
//    await logit.debug("## returnSQLDataArray() count=\(data.count) ##")
//    return(data)
//}
...
//
////@MainActor let a: SqlDailyTracker = SqlDailyTracker(
...
////)
//
//@MainActor let sampleSQLArray: [SqlDailyTracker] = [b]
//
//@MainActor let dateISOFormatter = ISO8601DateFormatter()
//
////let mockDB: [SqlDailyTracker] = returnSQLDataArray()
//@MainActor var mockDB: [SqlDailyTracker] =  [
//    // Existing 2015 entry
//    SqlDailyTracker(
...
//        ],
//        weightAM: SqlDataWeightRecord(date: Date(), weightType: .am, kg: 40.82),
...
//        itemsDict: [
//            DataCountType.dozeBeans: SqlDataCountRecord(datacount_date_psid: "2025-06-25", datacount_kind_pfnid: 1, datacount_count: 3, datacount_streak: 1)!,
//            DataCountType.dozeBerries: SqlDataCountRecord(datacount_date_psid: "2025-06-25", datacount_kind_pfnid: 2, datacount_count: 1, datacount_streak: 1)!,
//            DataCountType.dozeBeverages: SqlDataCountRecord(datacount_date_psid: "2025-06-25", datacount_kind_pfnid: 11, datacount_count: 2, datacount_streak: 1)!
//        ],
//        weightAM: SqlDataWeightRecord(date: Calendar.current.date(from: DateComponents(year: 2025, month: 6, day: 25))!, weightType: .am, kg: 74, timeHHmm: "03:30"),
//        weightPM: SqlDataWeightRecord(date: Calendar.current.date(from: DateComponents(year: 2025, month: 6, day: 25))!, weightType: .am, kg: 73, timeHHmm: "20:30")
//    ),
//    SqlDailyTracker(
...
//            DataCountType.dozeBerries: SqlDataCountRecord(datacount_date_psid: "2025-07-06", datacount_kind_pfnid: 2, datacount_count: 1, datacount_streak: 1)!,
//            DataCountType.dozeBeverages: SqlDataCountRecord(datacount_date_psid: "2025-07-06", datacount_kind_pfnid: 11, datacount_count: 2, datacount_streak: 1)!
//        ],
...
//]
//
//@MainActor let b: SqlDailyTracker = SqlDailyTracker(
