...
//    public func create(_ r: SqlDataCountRecord) async {
...
//            await logit.error("FAIL: ItemModel create(_ item: ItemRecord))")
//        }
//    }
//    
//    /// same as updateOrCreate()
//    public func createOrUpdate(_ r: SqlDataCountRecord) async {
...
//    public func readOne(date: Date, countType: DataCountType) async -> SqlDataCountRecord? {
//        let dateSid = date.datestampSid
//        let kindNid = countType.nid
//        return await readOne(date: dateSid, kind: kindNid)
//    }
//    
//    /// returns 1 record from database if present
//    public func readOne(date: String, kind: Int) async -> SqlDataCountRecord? {
...
//                await logit.error("ERROR: item_puid NOT UNIQUE")
//                return nil
//            }
//            
...
//    public func update(_ new: SqlDataCountRecord) async {
//        guard let old = await readOne(date: new.datacount_date_psid, kind: new.datacount_kind_pfnid)
//            else { return }
//        
...
//    public func updateOrCreate(_ r: SqlDataCountRecord) async {
//        await createOrUpdate(r)
//    }
//    
//    public func delete(_ r: SqlDataCountRecord) async {
...
//            \(result.toStringTsv())
//            """
//            await logit.verbose(s)
//        } else {
//            await logit.verbose("DELETE: move along, nothing to see here.")
//        }
//        #endif
//    }
//    
...
//        """
//        
//        await logit.verbose("• sql\n\(sql)")
//        let query = SQLiteQuery(sql: sql, db: api.dailydozenDb)
//        await logit.verbose("query \(query.getStatus().toString())")
//    }
//    
//}
