...
//    public func create(_ r: SqlDataWeightRecord) async {
...
//           await logit.error("FAIL: SqlDataWeightModel create(_ item: SqlDataWeightRecord))")
//        }
//    }
//    
//    /// same as updateOrCreate()
//    public func createOrUpdate(_ r: SqlDataWeightRecord) async {
...
//    public func readOne(date: String, kind: Int) async -> SqlDataWeightRecord? {
...
//    public func update(_ new: SqlDataWeightRecord) async {
//        guard let old = await readOne(date: new.dataweight_date_psid, kind: new.dataweight_ampm_pnid)
//            else { return }
//        
...
//    public func updateOrCreate(_ r: SqlDataWeightRecord) async {
//        await createOrUpdate(r)
//    }
//    
//    public func delete(_ r: SqlDataWeightRecord) async {
...
//            await logit.debug(s)
//        } else {
//            await logit.debug("DELETE: move along, nothing to see here.")
//        }
//        #endif
//    }
//    
...
//        """
//        
//        await logit.debug("• sql\n\(sql)")
//        let query = SQLiteQuery(sql: sql, db: api.dailydozenDb)
//        await logit.debug("query \(query.getStatus().toString())")
//    }
//    
//}
